...
function loadSources() {
  return {
    ...
    [PROMISE]: Task.spawn(function*() {
      let response = yield rdpInvoke(gThreadClient, gThreadClient.getSources);
  ...
  return (dispatch, getState) => {
    ...
    return dispatch({
      ...
      [PROMISE]: Task.spawn(function*() {
        ...
        let sourceText = getSourceText(getState(), source.actor);
        let contentType = sourceText ? sourceText.contentType : null;
...
function loadSourceText(source) {
  return (dispatch, getState) => {
    ...
    let sourceClient = getSourceClient(source);
    ...
    return dispatch({
      ...
      [PROMISE]: Task.spawn(function*() {
        ...
        let  response = yield rdpInvoke(sourceClient, sourceClient.source);
